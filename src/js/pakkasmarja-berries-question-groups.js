...
(function() {
  ...
  $.widget("custom.pakkasmarjaBerriesQuestionGroups", {
    ...
    _onChatQuestionGroupThreadClick: function(event) {
      ...
      $(".chat-container").pakkasmarjaBerriesChatThread('joinThread', threadId, threadTitle, null, groupImageUrl, `Kysymysryhmä ${groupTitle}`, null, null, false);
    },
    ...
    _onQuestionThreadSelected: function (event, data) {
      ...
      $(".chat-container").pakkasmarjaBerriesChatThread('joinThread', threadId, this.selectedQuestionGroupTitle, null, this.selectedQuestionGroupImageUrl, `Kysymysryhmä`, null, null, false);
